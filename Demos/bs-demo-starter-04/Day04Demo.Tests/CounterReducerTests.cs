...
public class CounterReducerTests
{
    ...
    [Fact]
    public void ReduceResetToZeroCounterAction_WithCountOf5_ReturnsCountOf0()
    {
        var state = new CounterState { Count = 5 };
        var action = new ResetToZeroCounterAction();

        var result = CounterReducers.ReduceResetToZeroCounterAction(state, action);
