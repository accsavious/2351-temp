...
public static class CounterReducers
{
    ...
    [ReducerMethod]
    public static CounterState ReduceResetToZeroCounterAction(CounterState state,
                        ResetToZeroCounterAction action)
    {
        return state with { Count = 0 };
    }
    public static CounterState ReduceSetCounterAction(CounterState state,
